    ...
    def __init__(
        ...
        *,
        ...
        self._chinese_provider = chinese_provider or ChineseSubtitleProvider(
            ...
            captcha_ocr_endpoint=settings.effective_captcha_ocr_endpoint,
            captcha_ocr_timeout_seconds=settings.captcha_ocr_timeout_seconds,
            captcha_ocr_auto_submit=settings.captcha_ocr_auto_submit,
            captcha_ocr_auto_max_attempts=settings.captcha_ocr_auto_max_attempts,
            captcha_ocr_min_confidence=settings.captcha_ocr_min_confidence,
            cookiecloud_url=settings.effective_cookiecloud_url,
            cookiecloud_key=settings.effective_cookiecloud_key,
            cookiecloud_password=settings.effective_cookiecloud_password,
            cookiecloud_sync_interval_seconds=settings.effective_cookiecloud_sync_interval_seconds,
        )
